      ...
      try {
        ...
        if (data) {
          const workspaceData: WorkspaceWithMembership = {
            ...
            workspace_member_role: Array.isArray(data.workspace_members) ? data.workspace_members[0]?.workspace_member_role : undefined,
            membership_type: Array.isArray(data.workspace_application_settings) ? data.workspace_application_settings[0]?.membership_type : undefined
          }
