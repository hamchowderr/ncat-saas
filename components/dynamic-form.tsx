      ...
      <FormField
        ...
        render={({ field }) => {
          ...
          switch (typeName) {
            ...
            case "string":
              return (
                <FormItem className="border-b py-6">
                  <div className="flex w-full flex-col justify-between gap-4 lg:flex-row lg:items-center lg:gap-8">
                    <div className="flex-1 pr-4">
                      <FormLabel>{label}</FormLabel>
                      <div className="text-muted-foreground mt-1 text-sm">{typeDisplay}</div>
              ...
              return (
                <FormItem className="border-b py-6">
                  <div className="flex w-full flex-col justify-between gap-4 lg:flex-row lg:items-center lg:gap-8">
                    <div className="flex-1 pr-4">
                      <FormLabel>{label}</FormLabel>
                      <div className="text-muted-foreground text-sm">{typeDisplay}</div>
                      {description && <FormDescription>{description}</FormDescription>}
                      <FormMessage />
                    </div>
                    <div className="flex-1 lg:max-w-1/2">
            ...
            case "boolean":
              return (
                <FormItem className="flex flex-row items-center justify-between gap-8 border-b py-6">
                  <div>
                    <FormLabel>{label}</FormLabel>
                    <div className="text-muted-foreground text-sm">{typeDisplay}</div>
                    {description && <FormDescription>{description}</FormDescription>}
