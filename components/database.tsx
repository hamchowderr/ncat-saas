...
function EditRowView({
  ...
  return (
    <div className="px-6 pt-4 pb-10 lg:px-12 lg:pt-10">
      <h2 className="mb-4 text-base font-semibold lg:text-xl">Editing row in {table.name}</h2>
      <DynamicForm
        schema={formSchema}
        initialValues={row}
    ...
    <div className="p-6 pt-4 lg:p-8 lg:pt-8">
      ...
      {isError && (
        <Alert variant="destructive" className="mt-8">
          ...
          <AlertDescription>
            There was a problem loading your database tables. Please check your Supabase connection
            and ensure your project has the necessary permissions.
            {isError && typeof isError === "object" && isError && "message" in isError && (
