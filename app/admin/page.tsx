    ...
    <div className="container mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-2">
          Manage your Supabase backend services including database, authentication, storage, and
          more.
        </p>
      </div>
      ...
      <div className="flex justify-center">
        <Card className="w-full max-w-md">
          <CardHeader>
            ...
            <CardDescription>
              Access your Supabase project&apos;s database, authentication, storage, logs, and other
              backend services.
            </CardDescription>
          </CardHeader>
          <CardContent>
